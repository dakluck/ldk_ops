...
| **MBMA School Calendar Sync** | `0 19 * * *` (Daily 7:00 PM) | `mbma_calendar_sync.py` | Scans `dailey.kluck@gmail.com` for MBMA communications. Reconciles events, preparation deadlines, and teacher milestones with full favorites profiles, updating `.mbma_events_state.json` and sending RFC 5545 calendar invites to Dailey & Lauren. |
